                            ...
                            .addCallback(new Callback() {
                                ...
                                public void onCreate(@NonNull SupportSQLiteDatabase db) {
                                    ...
                                    Executors.newSingleThreadExecutor().execute(() -> {
                                        ...
                                        dao.insert(new KeywordAction("向前", VehicleMode.UAV.name(),"20 00 30 77"));
                                        dao.insert(new KeywordAction("向後", VehicleMode.UAV.name(),"20 10 30 77"));
                                        dao.insert(new KeywordAction("向左邊", VehicleMode.UAV.name(),"20 20 30 77"));
                                        dao.insert(new KeywordAction("向右邊", VehicleMode.UAV.name(),"20 30 30 77"));
                                        dao.insert(new KeywordAction("向下", VehicleMode.UAV.name(),"20 40 30 77"));
                                        dao.insert(new KeywordAction("向上", VehicleMode.UAV.name(),"20 50 30 77"));
                                        dao.insert(new KeywordAction("起飛", VehicleMode.UAV.name(),"20 60 30 77"));
                                        dao.insert(new KeywordAction("降落", VehicleMode.UAV.name(),"20 70 30 77"));
                                        dao.insert(new KeywordAction("懸停", VehicleMode.UAV.name(),"20 80 30 77"));
                                        //dao.insert(new KeywordAction("自旋", VehicleMode.UAV.name(),"20 90 30 77"));
                                        dao.insert(new KeywordAction("向左旋轉", VehicleMode.UAV.name(),"20 90 30 77"));
                                        dao.insert(new KeywordAction("向右旋轉", VehicleMode.UAV.name(),"20 98 30 77"));
